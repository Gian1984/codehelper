...
useHead({
  ...
  meta: [
    ...
    { property: 'og:image', content: `https://codehelper.me/og-image.php?title=${encodeURIComponent(gameData.title)}&type=game` },
    { property: 'og:url', content: `https://codehelper.me/games/${slug}/` },
    { property: 'og:type', content: 'website' },
    { name: 'twitter:card', content: 'summary_large_image' },
    { name: 'twitter:title', content: gameData.seo?.title || gameData.title },
    { name: 'twitter:description', content: gameData.seo?.description || gameData.description },
    { name: 'twitter:image', content: `https://codehelper.me/og-image.php?title=${encodeURIComponent(gameData.title)}&type=game` },
