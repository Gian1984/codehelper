...
useHead({
  ...
  meta: [
    ...
    { property: 'og:image', content: gameData.seo?.ogImage || 'https://codehelper.me/images/codehelper_blog_OG.webp' },
    ...
    { name: 'twitter:image', content: gameData.seo?.ogImage || 'https://codehelper.me/images/codehelper_blog_OG.webp' },
